...
function WorkflowMockup() {
  return (
    <div className="rounded-3xl border border-gray-200 bg-white/80 p-4 shadow-inner">
      ...
      <div className="mt-5 grid grid-cols-[minmax(0,1fr)_14px_minmax(0,1fr)_14px_minmax(0,1fr)] items-center gap-1.5 sm:grid-cols-[minmax(0,1fr)_18px_minmax(0,1fr)_18px_minmax(0,1fr)] sm:gap-3">
        <div className="min-w-0 rounded-xl border border-green-200 bg-green-50 px-1.5 py-2 text-center text-[10px] font-semibold text-green-700 sm:rounded-2xl sm:px-3 sm:text-xs">
          Trigger
        </div>
        <ArrowRight className="mx-auto text-gray-300" size={14} />
        <div className="min-w-0 rounded-xl border border-gray-200 bg-gray-50 px-1.5 py-2 text-center text-[10px] font-semibold text-gray-600 sm:rounded-2xl sm:px-3 sm:text-xs">
          Validate
        </div>
        <ArrowRight className="mx-auto text-gray-300" size={14} />
        <div className="min-w-0 rounded-xl border border-gray-200 bg-gray-900 px-1.5 py-2 text-center text-[10px] font-semibold text-white sm:rounded-2xl sm:px-3 sm:text-xs">
          Launch
        </div>
      </div>
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.article
                ...
                className="group flex min-h-0 flex-col rounded-[1.5rem] border border-gray-200 bg-white/85 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.05)] transition duration-300 hover:-translate-y-1 hover:border-green-300 hover:shadow-[0_28px_80px_rgba(34,197,94,0.08)] sm:min-h-[28rem] sm:rounded-[2rem] sm:p-7"
              >
