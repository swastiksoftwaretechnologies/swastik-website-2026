...
class App {
  ...
  onWheel(e) {
    // Prevent the page from scrolling while interacting with the gallery
    e.preventDefault();
  ...
  addEventListeners() {
    ...
    // Wheel/touch events scoped to the gallery container so they don't
    // intercept Lenis smooth-scroll on the rest of the page.
    ...
    // Mouse drag events stay on window so a drag started inside stays active
